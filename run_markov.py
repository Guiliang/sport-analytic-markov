...
if __name__ == "__main__":
    ...
    player_impact_dict, player_Q_dict = aggregate_player_impact(init_ref_node_tree=init_ref_node_tree,
                                                                data_dir=soccer_data_dir,
    ...
    #
    json.dump(player_Q_dict, open('./player_impact/'
                                       'soccer_player_markov_q-{0}{1}.json'.
                                       format(datetime.date.today().strftime("%Y%B%d"), focus_action), 'w'))
